 ...
 */
UCLASS(abstract)
class BATTLE_API AShooterNPC : public AbattleCharacter, public IShooterWeaponHolder
{
	GENERATED_BODY()
...
protected:
	...
	/** Whether to call IncrementTeamScore on death. Override to return false for custom scoring. */
	virtual bool ShouldIncrementTeamScore() const { return true; }
