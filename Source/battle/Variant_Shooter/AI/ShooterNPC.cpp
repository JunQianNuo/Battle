...
void AShooterNPC::BeginPlay()
{
	...
	// spawn the weapon (skip if no WeaponClass set, e.g. melee enemies)
	if (WeaponClass)
	{
...
void AShooterNPC::Die()
{
	...
	// increment the team score (skip for subclasses with custom scoring)
	if (ShouldIncrementTeamScore())
	{
